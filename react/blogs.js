...
function Navbar(){
        return(
            <div className="cont">
			<div className="log">
				<div className="log-img"><img src="imgs/logo.png" alt="log" /></div>
                            ...
                            <div className="art-item" key={data._id}>
                                <div className="row">
                                    ...
                                    <div className="col-content">
                                        ...
                                        <div className="body">
                                            <div dangerouslySetInnerHTML={{__html: this.cutStr(data.body,13) + '...'}}/>
                                        </div>
        ...
        return(
			...
			<div className="row">
				...
				<div className="col-4">
					...
					<ul>
						<li>
							<a href="https://www.linkedin.com/in/uwawe-terah-90005724a/" target="_blank">
